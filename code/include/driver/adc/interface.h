...
public:
     ...
     */
    virtual uint16_t read(const uint8_t channel) const noexcept = 0;
     ...
     */
    virtual double dutyCycle(const uint8_t channel) const noexcept = 0;
     ...
     */
    virtual double inputVoltage(const uint8_t channel) const noexcept = 0;
     ...
     */
    virtual bool isChannelValid(const uint8_t channel) const noexcept = 0;
};
} // namespace adc
} // namespace driver
